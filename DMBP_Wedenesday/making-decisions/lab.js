...
else if (amysAge < brittanisAge) console.log(`Brittani is older.`);
else console.log("Amy and Brittani are the same age.");

/* 
[][][][][][][][][][][][][][][][][][][][][] My thoughts [][][][][][][][][][][][][][][][][][][][][]
Not sure why they use AGE and BIRTH YEAR variables above when it doesn't matter with one you use.
Without the month and day, you can't use the birth year any differently than you can from age.
As such, I just used the AGE variables and didn't bother with the birth years.
But, if needed, it will be as below:

  if (amysBirthYear === brittanisBirthYear) console.log("Amy and Brittani are the same age.");
  else if (amysBirthYear > brittanisBirthYear) console.log(`Amy is older.`);
...
/*
  ...
  If it is 60 degrees or below, one should wear a jacket and carry an umbrella. <======= This here makes no sense to carry an umbrella. I added 'rain' being 'true' because it bugged me.
...
if (temperature < 60  && rain === true) console.log("One should wear a jacket and carry an umbrella.");

if (temperature > 80 && rain !== true) console.log("One should wear a t-shirt and shorts.");
if (temperature > 60 && temperature < 80 && rain !== true) console.log("One should wear a jacket.");
if (temperature < 60  && rain !== true) console.log("One should wear a jacket and scarf.");
////////// PROBLEM 5 //////////
/*
...
if (changeMyMind) {
  console.log("changeMyMind variable is true. Changing it to false.");
  changeMyMind = false;
} else { 
  console.log("changeMyMind variable is false. Changing it to true.");
  changeMyMind = true;
}
////////// PROBLEM 10 //////////
